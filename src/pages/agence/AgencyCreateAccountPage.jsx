      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <motion.div
            ...
            className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border-t-4 border-orange-500"
          >
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {!isInviteFlow && (
                <div>
                  <Label htmlFor="agencyName" className="text-blue-700">Nom de l'agence</Label>
              ...
              <div>
                <Label htmlFor="phone" className="text-blue-700">Téléphone (optionnel)</Label>
                <div className="mt-1 relative rounded-md shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <Label htmlFor="email" className="text-blue-700">Adresse email professionnelle</Label>
                <div className="mt-1 relative rounded-md shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <Label htmlFor="confirmPassword" className="text-blue-700">Confirmer le mot de passe</Label>
                <div className="mt-1 relative rounded-md shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock className="h-5 w-5 text-gray-400" />
                  </div>
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm text-blue-600">
                  J'accepte les{" "}
                  <Link to="/cgu" className="font-semibold text-blue-600 hover:text-blue-800">
              ...
              <Button
                type="submit"
                className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-md shadow transition duration-150 ease-in-out"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
