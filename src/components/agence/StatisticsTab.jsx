...
export default function StatisticsTab({
  ...
  useEffect(() => {
    console.log("[StatisticsTab] agencyId =", agency?.id);
    console.log("[StatisticsTab] viewerRole =", viewerRole);
    console.log("[StatisticsTab] viewerProfessionnelId =", viewerProfessionnelId);
    console.log("[StatisticsTab] scopeType =", scopeType);
    console.log("[StatisticsTab] overview =", overview);
    console.log("[StatisticsTab] memberStats =", memberStats);
  }, [agency?.id, viewerRole, viewerProfessionnelId, scopeType, overview, memberStats]);
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">{scopeMeta.scopeLabel}</p>
        </div>
